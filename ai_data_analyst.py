...
# Load .env file
load_dotenv()
# Try to get API key from Streamlit secrets first, then .env, then user input
default_openai_key = ""
api_key_source = ""
if hasattr(st, "secrets") and "OPENAI_API_KEY" in st.secrets:
    default_openai_key = st.secrets["OPENAI_API_KEY"]
    api_key_source = "[Loaded from Streamlit secrets]"
elif os.getenv("OPENAI_API_KEY"):
    default_openai_key = os.getenv("OPENAI_API_KEY")
    api_key_source = "[Loaded from .env]"
else:
    api_key_source = "[Paste your API key]"
...
with st.sidebar:
    ...
    if openai_key:
        ...
        if openai_key == default_openai_key and default_openai_key:
            st.success(f"API key loaded automatically! {api_key_source}")
        else:
